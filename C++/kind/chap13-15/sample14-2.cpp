...
Car::Car(int n, double g)   //基本クラスの引数2個のコンストラクタ
{
  num = n;
  gas = g;
  cout << "ナンバ" << num << "ガソリン量" << gas << "の車を作成しました。\n";
}
...
RacingCar::RacingCar(int n, double g, int c) : Car(n, g)   //基本クラスの引数2個のコンストラクタが呼び出されるようにする。
{
  course = c;
